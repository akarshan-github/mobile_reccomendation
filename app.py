...
df = pickle.load(file=open(file=r'dataframe.pkl', mode='rb'))
similarity = pickle.load(file=open(file=r'similarity.pkl', mode='rb'))
...
if st.button('Recommend'):
    ...
    mobile_name_variety, mobile_IMG_variety, mobiles_ratings_variety, mobiles_price_variety = recommend_different_variety(
        selected_mobile)
